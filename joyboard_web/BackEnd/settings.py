...
# ------------------------------ Sanity Checks Values ------------------------------
LEVEL1_TIME = int(os.environ["LEVEL1_TIME"])
LEVEL2_TIME = int(os.environ["LEVEL2_TIME"])
LEVEL3_TIME = int(os.environ["LEVEL3_TIME"])
LEVEL4_TIME = int(os.environ["LEVEL4_TIME"])
LEVEL5_TIME = int(os.environ["LEVEL5_TIME"])